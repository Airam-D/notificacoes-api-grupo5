...
- [x] NotificacaoService criado com listarTodas, buscarPorId, reenviar, estatísticas
- [x] Filtros por tipo e status de envio funcionando
- [x] Endpoint de estatísticas retornando contagens
- [x] Reenvio de notificação funcionando
- [x] Regra de não duplicar implementada (desafio)
- [x] Commit e push
