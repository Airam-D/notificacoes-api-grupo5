...
- [x] Base template criado com layout profissional (header, body, footer)
- [x] Template de confirmação de inscrição funcionando
- [x] Template de cancelamento funcionando
- [x] Observer refatorado para usar templates
- [x] E-mails bonitos visíveis no MailPit
- [x] Notificações salvas no banco com HTML completo
- [x] Template de lembrete criado (desafio)
- [x] Commit e push
