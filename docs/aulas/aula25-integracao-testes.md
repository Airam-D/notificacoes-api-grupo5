...
- [x] Teste end-to-end executado (17 passos)
- [x] `docs/teste-integracao.md` preenchido com resultados
- [x] Problemas encontrados corrigidos
- [x] Swagger atualizado com rotas de Notificações
- [x] Collection do Postman atualizada e exportada
- [ ] Commit e push
