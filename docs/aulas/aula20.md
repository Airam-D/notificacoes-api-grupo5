...
### Banco de Dados:
- [x] MySQL configurado e conectado
- [x] 4 Models Sequelize com validações e relacionamentos
- [x] Migrations para todas as tabelas
- [x] Seeds com dados iniciais
- [x] Scripts de banco no package.json (migrate, seed, reset)

### CRUD:
- [x] CRUD completo de Eventos com Sequelize
- [x] CRUD completo de Participantes com Sequelize
- [x] Inscrições com validações de duplicata e existência
- [x] Dados persistem entre reinícios do servidor

### Funcionalidades:
- [x] Paginação e filtros no GET /eventos
- [x] Exportação em XML e JSON
- [x] Upload de arquivos (banner de evento)
- [x] Relatório de inscrições
- [x] Cache em memória

### Documentação:
- [x] Swagger atualizado com novas rotas
