...
- [x] Auditoria feita — listei quais rotas faltavam
- [x] Todas as 23+ rotas documentadas no Swagger
- [x] Schemas de todas as entidades (Evento, Participante, Inscrição, Notificação, Erro)
- [x] Exemplos de request/response em cada rota
- [x] "Try it out" funciona para todas as rotas
- [x] Commit e push
