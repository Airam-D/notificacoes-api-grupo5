...
[tabela com rotas] (<http://localhost:3000/routes/eventoRoutes>)

### Participantes

[tabela com rotas] (<http://localhost:3000/routes/participanteRoutes>)

### Inscrições

[tabela com rotas] (<http://localhost:3000/routes/inscricaoRoutes>)

### Notificações

[tabela com rotas] (<http://localhost:3000/routes/notificacaoRoutes>)

### Exportação

[tabela com rotas] (<http://localhost:3000/routes/exportRoutes>)
...
- [x] README final profissional e completo
- [x] Testes manuais passando (local + produção)
- [x] Nenhum arquivo sensível no repositório
- [x] Todos os membros com commits
- [x] `.env.example` com todas as variáveis
- [x] Collection do Postman exportada em `docs/`
